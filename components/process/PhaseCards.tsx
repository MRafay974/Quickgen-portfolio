...
function CardLayout({
  ...
  return (
    <ScrollRevealCard className="w-full">
      <div className={`${bgColor} rounded-2xl px-6 py-6 md:px-10 md:py-7 flex flex-col items-center max-w-7xl mx-auto`}>
        ...
        {/* Description — centered, max-width capped */}
...
export function CreateCard2() {
  return (
    <CardLayout
      ...
      bullets={["Component testing", "3D printing", "In-house mockups", "Initial renders"]}
...
export function CreateCard3() {
  return (
    <CardLayout
      ...
      bullets={["High quality models/renders", "Low volume PCBs", "Product testing"]}
...
export function RefineCard1() {
  return (
    <CardLayout
      ...
      bullets={["CMS", "Final design tweaks", "Patent applications", "Industry certifications"]}
...
export function RefineCard2() {
  return (
    <CardLayout
      ...
      bullets={["Cost optimization", "Assembly analysis", "Final PCB", "Code updates"]}
...
export function LaunchCard1() {
  return (
    <CardLayout
      ...
      bullets={["Quotes", "Final samples/models", "Component sourcing", "Logistics"]}
...
export function LaunchCard2() {
  return (
    <CardLayout
      ...
      bullets={["New technology integration", "Marketing material", "V2 Design"]}
